...
TESTS := tests/test_json tests/test_ws tests/test_jsonw tests/test_config tests/test_http tests/test_bridge tests/test_render tests/test_server_window tests/test_grappa_admin
...
tests/test_server_window: tests/test_server_window.c tests/test.h src/connection.c
	$(CC) $(CPPFLAGS) $(TEST_CFLAGS) -o $@ tests/test_server_window.c src/bridge.c src/http.c src/ws_client.c src/ws.c src/json.c src/jsonw.c src/config.c -lssl -lcrypto -lpthread
...
tests/test_grappa_admin: tests/test_grappa_admin.c tests/test.h src/connection.c
	$(CC) $(CPPFLAGS) $(TEST_CFLAGS) -o $@ tests/test_grappa_admin.c src/bridge.c src/http.c src/ws_client.c src/ws.c src/json.c src/jsonw.c src/config.c -lssl -lcrypto -lpthread
